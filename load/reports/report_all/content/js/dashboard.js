...
$(document).ready(function() {
    ...
    var data = {"OkPercent": 55.666666666666664, "KoPercent": 44.333333333333336};
    var dataset = [
        {
            "label" : "FAIL",
            "data" : data.KoPercent,
    ...
    // Creates APDEX table
    createTable($("#apdexTable"), {"supportsControllersDiscrimination": true, "overall": {"data": [0.2783333333333333, 500, 1500, "Total"], "isController": false}, "titles": ["Apdex", "T (Toleration threshold)", "F (Frustration threshold)", "Label"], "items": [{"data": [0.5, 500, 1500, "HTTP Request #3"], "isController": false}, {"data": [0.335, 500, 1500, "HTTP Request #2"], "isController": false}, {"data": [0.0, 500, 1500, "HTTP Request #1"], "isController": false}]}, function(index, item){
        switch(index){
            case 0:
                item = item.toFixed(3);
                break;
    ...
    createTable($("#statisticsTable"), {"supportsControllersDiscrimination": true, "overall": {"data": ["Total", 300, 133, 44.333333333333336, 1680.0400000000018, 530, 10267, 733.0, 5831.0, 7053.0, 10252.540000000006, 2.168021680216802, 0.4890752032520325, 0.3345189701897019], "isController": false}, "titles": ["Label", "#Samples", "FAIL", "Error %", "Average", "Min", "Max", "Median", "90th pct", "95th pct", "99th pct", "Transactions/s", "Received", "Sent"], "items": [{"data": ["HTTP Request #3", 100, 0, 0.0, 549.6799999999996, 530, 634, 548.5, 570.9, 577.9, 633.5699999999998, 3.3478406427854033, 0.7552257700033478, 0.516561349179779], "isController": false}, {"data": ["HTTP Request #2", 100, 33, 33.0, 2459.4400000000014, 715, 8105, 733.0, 6848.2000000000035, 8084.249999999995, 8104.99, 1.6790919470750219, 0.3787795310296192, 0.25907864027134125], "isController": false}, {"data": ["HTTP Request #1", 100, 100, 100.0, 2031.0000000000007, 1111, 10267, 1146.0, 4491.0, 9484.99999999997, 10266.96, 2.0432348494135915, 0.46092504903763637, 0.3152647521556128], "isController": false}]}, function(index, item){
        switch(index){
            // Errors pct
            case 3:
                item = item.toFixed(2) + '%';
    ...
    createTable($("#top5ErrorsBySamplerTable"), {"supportsControllersDiscrimination": false, "overall": {"data": ["Total", 300, 133, "The operation lasted too long: It took 1,131 milliseconds, but should not have lasted longer than 790 milliseconds.", 10, "The operation lasted too long: It took 1,136 milliseconds, but should not have lasted longer than 790 milliseconds.", 5, "The operation lasted too long: It took 4,998 milliseconds, but should not have lasted longer than 790 milliseconds.", 5, "The operation lasted too long: It took 1,132 milliseconds, but should not have lasted longer than 790 milliseconds.", 4, "The operation lasted too long: It took 8,104 milliseconds, but should not have lasted longer than 790 milliseconds.", 4], "isController": false}, "titles": ["Sample", "#Samples", "#Errors", "Error", "#Errors", "Error", "#Errors", "Error", "#Errors", "Error", "#Errors", "Error", "#Errors"], "items": [{"data": [], "isController": false}, {"data": ["HTTP Request #2", 100, 33, "The operation lasted too long: It took 4,998 milliseconds, but should not have lasted longer than 790 milliseconds.", 5, "The operation lasted too long: It took 6,327 milliseconds, but should not have lasted longer than 790 milliseconds.", 4, "The operation lasted too long: It took 8,104 milliseconds, but should not have lasted longer than 790 milliseconds.", 4, "The operation lasted too long: It took 5,831 milliseconds, but should not have lasted longer than 790 milliseconds.", 3, "The operation lasted too long: It took 6,314 milliseconds, but should not have lasted longer than 790 milliseconds.", 3], "isController": false}, {"data": ["HTTP Request #1", 100, 100, "The operation lasted too long: It took 1,131 milliseconds, but should not have lasted longer than 790 milliseconds.", 10, "The operation lasted too long: It took 1,136 milliseconds, but should not have lasted longer than 790 milliseconds.", 5, "The operation lasted too long: It took 1,132 milliseconds, but should not have lasted longer than 790 milliseconds.", 4, "The operation lasted too long: It took 7,053 milliseconds, but should not have lasted longer than 790 milliseconds.", 3, "The operation lasted too long: It took 1,310 milliseconds, but should not have lasted longer than 790 milliseconds.", 3], "isController": false}]}, function(index, item){
        return item;
    }, [[0, 0]], 0);
